...
export default function Developers() {
    const [developersAll, setDevelopers] = useState([]);
 
    useEffect(() => {
        (async () => {
            const response = await fetch('http://localhost:3030/jsonstore/developers');
